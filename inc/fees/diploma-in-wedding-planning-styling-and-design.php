<div class="grav-form-wrap enrol-section section-diploma-in-wedding-planning-styling-and-design">
...
<div class="row">
    ...
    <h2 class="title center-align">Diploma in Wedding Planning<span class="em"><br>Styling &amp; Design</span></h2>
    </div>
</div>
</div>
...
'post_type' => 'product', 
'posts_per_page' => 4, 
'product_cat' => 'diploma-in-wedding-planning-styling-and-design', 
'orderby' => 'menu_order', 
'order'   => 'ASC' );
...
<?php if(get_field('payment_plan_option') == 'full' )  : ?>
  ...
  <?php endwhile; rewind_posts(); ?>
      ...
      <a href="<?php bloginfo('url'); ?>/courses/diploma-in-wedding-planning-styling-and-design" class="btn btn-primary">View Course</a>
