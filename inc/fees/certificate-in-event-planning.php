<div class="grav-form-wrap enrol-section section-certificate-in-event-planning">
...
<div class="row">
    ...
    <h2 class="title center-align">certificate in<span class="em"><br>Event Planning</span></h2>
    </div>
</div>
</div>
...
'post_type' => 'product', 
'posts_per_page' => 4, 
'product_cat' => 'certificate-in-event-planning', 
'orderby' => 'menu_order', 
'order'   => 'ASC' );
...
<?php if(get_field('payment_plan_option') == 'full' )  : ?>
  ...
  <?php endwhile; rewind_posts(); ?>
      ...
      <a href="<?php bloginfo('url'); ?>/courses/certificate-in-event-planning" class="btn btn-primary">View Course</a>
