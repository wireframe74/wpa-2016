<div class="grav-form-wrap enrol-section section-diploma-in-venue-coordination">
...
<div class="row">
    ...
    <h2 class="title center-align">Diploma in <span class="em"><br>Venue Coordination</span></h2>
    </div>
</div>
</div>
...
'post_type' => 'product', 
'posts_per_page' => 4, 
'product_cat' => 'diploma-in-venue-coordination', 
'orderby' => 'menu_order', 
'order'   => 'ASC' );
...
<?php if(get_field('payment_plan_option') == 'full' )  : ?>
  ...
  <?php endwhile; rewind_posts(); ?>
      ...
      <a href="<?php bloginfo('url'); ?>/courses/diploma-in-venue-coordination" class="btn btn-primary">View Course</a>
